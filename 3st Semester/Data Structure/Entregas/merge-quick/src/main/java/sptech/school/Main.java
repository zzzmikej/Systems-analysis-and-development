...
public class Main {
    public static void main(String[] args) {
        int[] v = {2, 3, 8, 6, 5, 7, 1, 4, 1000, -1, -5, 3, 5};
        ...
        System.out.println("QuickSort (Pivô no meio): " + Arrays.toString(quickSortMeioPivo));
        System.out.println("QuickSort (Pivô como ultimo): " + Arrays.toString(quickSortUltimoPivo));
    }
